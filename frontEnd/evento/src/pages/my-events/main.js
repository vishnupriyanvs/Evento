            ...
            {sideCheck ?
                <div id="parent-node">
                    ...
                    <div className='ul-div'>
                        ...
                        <div className='li-div'><div className='li-div-text' onClick={() => {navigateEvents(`my-events/upcoming-events/accepted/${id}`);setTitles('My Events - Upcoming - Accepted')}}>Accepted Events</div></div>
                    ...
                    <div className='sideBarIcons'><FontAwesomeIcon icon={faCalendar} size="2x" color="#91A4B7" onClick={() => {navigateEvents(`my-events/calendar-events/${id}`);setTitles('My Events - Calendar')}} /><span className='sideBarText'>Calendar</span></div>
                    ...
                    <div className='sideBarIcons'><FontAwesomeIcon icon={faFastForward} size="2x" color="#91A4B7" onClick={() => {navigateEvents(`my-events/ongoing-events/${id}`);setTitles('My Events - Ongoing Events - Accepted')}} /><span className='sideBarText'>Ongoing Events</span></div>
